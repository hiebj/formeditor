...
Ext.define('Ext.ux.grid.FormEditor', {
	...
	/**
	 * {@link Ext.Component#showBy} was not introduced until ExtJS 4.1.3. This function will be injected into
	 * the {@link #form} for compatibility with older versions of ExtJS.
	 */ 
